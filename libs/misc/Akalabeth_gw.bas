...
1091 LOCATE 22,30:PRINT "FOOD=";MID$(STR$(INT(PW(0)*10+.5)/10),2);:GOSUB 60868:LOCATE 23,30:PRINT "H.P.=";C(0);:GOSUB 60868:LOCATE 24,30:PRINT "GOLD=";C(5);:GOSUB 60868:LOCATE 20,1
...
1096 LOCATE 22,30:PRINT "FOOD=";MID$(STR$(INT(PW(0)*10+.5)/10),2);:GOSUB 60868:LOCATE 23,30:PRINT "H.P.=";C(0);:GOSUB 60868:LOCATE 24,30:PRINT "GOLD=";C(5);:GOSUB 60868:LOCATE 20,1
